...
const STYLE_DETAIL_MESSAGES = {
  ...
  vi: {
    ...
    tabBasicInfo: 'Thông tin co ban',
    tabProcessInfo: 'Thông tin cong doan',
    tabTimeMatrix: 'Đơn giá mua vao',
    tabBom: 'BOM',
    save: 'Luu',
    loading: 'Đang tải thong tin style...',
    newTab: 'Them style',
    detailTab: 'Style: {name}',
    createSuccess: 'Da tao style moi.',
    updateSuccess: 'Đã cập nhật style.',
