const translations = {
  ...
  '해당 월의 근무요일에서 등록 공휴일을 제외': ['Registered holidays are excluded from the month’s working weekdays', 'Loại trừ ngày lễ đã đăng ký khỏi các ngày làm việc trong tháng'],
  '근무시간': ['Work hours', 'Giờ làm việc'], '연장근무시간': ['Overtime hours', 'Giờ tăng ca'], '특근시간': ['Holiday work hours', 'Giờ làm ngày lễ'], '근속연수': ['Years of service', 'Số năm làm việc'],
  '만근 충족값': ['Full-attendance factor', 'Hệ số đủ công'], '1 또는 0': ['1 or 0', '1 hoặc 0'], '만근이면 1, 아니면 0': ['1 for full attendance; otherwise 0', 'Đủ công là 1, nếu không là 0'],
  ...
  '급여 타입': ['Pay type', 'Loại lương'], '직급': ['Grade', 'Cấp bậc'], '단가': ['Rate', 'Đơn giá'], '계산 기준': ['Calculation basis', 'Cơ sở tính'],
