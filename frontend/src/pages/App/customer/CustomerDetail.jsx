...
const TEXT = {
  ...
  vi: {
    ...
    detailTab: 'Khách hàng: {name}',
    titleNew: 'Them khach hang',
    titleDetail: 'Chi tiết khach hang',
    saveCustomer: 'Luu',
    saveCustomerSuccess: 'Đã lưu thong tin khach hang.',
    saveError: 'Không thể luu thong tin khach hang.',
    customerLoadError: 'Không thể tai thong tin khach hang.',
