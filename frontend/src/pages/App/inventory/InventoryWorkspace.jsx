...
const PAGE_META = {
  ...
  entry: ['입출고', '거래 유형에 따라 출발·도착 창고와 수량 변동을 기록합니다.'],
  history: ['거래 내역', '모든 재고 증감과 정정 이력을 문서 단위로 조회합니다.'],
    ...
    <Stack spacing={2}>
      ...
      <Paper variant="outlined" sx={{ p: 2.5 }}>
        <Stack spacing={2.5}>
          ...
          <Box sx={{ display: 'flex', justifyContent: 'flex-end' }}><EmptyAction>입출고 저장</EmptyAction></Box>
        </Stack>
      </Paper>
    </Stack>
  );
