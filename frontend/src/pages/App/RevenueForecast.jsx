...
const TEXT = {
  ko: {
    ...
    production: '3. 생산 조건', workers: '투입 인원', advanced: '세부 계산 조건', hoursDay: '1일 근무시간', workdays: '월 근무일', wage: '1인 월 인건비',
  ...
  en: {
    ...
    production: '3. Production Conditions', workers: 'Workers', advanced: 'Detailed Calculation Settings', hoursDay: 'Hours per Day', workdays: 'Workdays per Month', wage: 'Monthly Labor Cost per Worker',
  ...
  vi: {
    ...
    production: '3. Điều kiện sản xuất', workers: 'Số người', advanced: 'Điều kiện tính chi tiết', hoursDay: 'Giờ làm mỗi ngày', workdays: 'Ngày làm mỗi tháng', wage: 'Chi phí lao động tháng mỗi người',
