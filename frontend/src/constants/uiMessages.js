...
export const UI_MESSAGES = {
  ...
  menu: {
    ...
    businessPartnerManagement: { ko: '거래처 관리', en: 'Business Partners', vi: 'Quản lý đối tác' },
    outsourcingPartner: { ko: '외주 업체', en: 'Outsourcing Partner', vi: 'Đối tác gia công' },
    materialSupplier: { ko: '공급 업체', en: 'Material Supplier', vi: 'Nhà cung cấp vật tư' },
    ...
    payroll: { ko: '급여 계산', en: 'Payroll', vi: 'Tính lương' },
    organization: { ko: '조직 관리', en: 'Organization', vi: 'Tổ chức' },
    settings: { ko: '설정', en: 'Settings', vi: 'Cài đặt' },
    personalSettings: { ko: '개인 설정', en: 'Personal Settings', vi: 'Cài đặt cá nhân' },
    ...
    factoryScope: { ko: '공장', en: 'Factory', vi: 'Nhà máy' },
  ...
  payrollBoard: {
    title: { ko: '급여 계산', en: 'Payroll', vi: 'Tính lương' },
    add: { ko: '급여 계산', en: 'Calculate Payroll', vi: 'Tính lương' },
    month: { ko: '\uC815\uC0B0 \uC6D4', en: 'Settlement Month', vi: 'Thang doi chieu' },
    employees: { ko: '\uB300\uC0C1 \uC778\uC6D0', en: 'Employees', vi: 'So nhan vien' },
    total: { ko: '생산수당 소계', en: 'Production Allowance Subtotal', vi: 'Tong phu cap san luong' },
  ...
  assign: {
    ...
    styleProcessVersionRequiredSaveError: { ko: '스타일 {styleLabel}의 공정 버전이 아직 하나도 확정되지 않아 저장하지 못했습니다. 스타일 상세 화면의 "공정 버전 관리"에서 Ver.1을 확정한 뒤 다시 저장해 주세요.', en: 'Save failed because style {styleLabel} has no confirmed process version yet. Open the style detail page, confirm Ver.1 under "Process Version Manager", then save again.', vi: 'Không lưu được vì kiểu dáng {styleLabel} chưa có phiên bản công đoạn nào được xác nhận. Vào trang chi tiết kiểu dáng, xác nhận Ver.1 trong "Quản lý phiên bản công đoạn" rồi lưu lại.' },
    ...
    expandUnassignedWork: { ko: '\uD3BC\uCE58\uAE30', en: 'Expand', vi: 'Mo rong' },
    collapseUnassignedWork: { ko: '\uC811\uAE30', en: 'Collapse', vi: 'Thu gon' },
    ...
    capacitySummaryHintFactoryPlan: {
      ko: '\uACFC\uAC70 \uC6D4\uC758 \uACC4\uD68D \uBD80\uD558\uB294 \uD574\uB2F9 \uC6D4 \uC2E4\uC81C \uC0DD\uC0B0\uB7C9\uACFC \uD604\uC7AC \uB0A8\uC740 \uBC30\uC815 \uC791\uC5C5\uC744 \uD568\uAED8 \uBC18\uC601\uD558\uACE0, \uC2E4\uC81C \uC0DD\uC0B0\uB960\uC740 \uC791\uC5C5 \uAE30\uB85D\uB9CC \uBC18\uC601\uD569\uB2C8\uB2E4. \uB0A8\uC740 \uC791\uC5C5\uC740 \uB9C8\uC9C0\uB9C9 \uAE30\uB85D \uB2E4\uC74C \uADFC\uBB34\uC77C\uBD80\uD130 \uC608\uCE21\uD569\uB2C8\uB2E4.',
    ...
    factoryScopeTimeline: { ko: '공장 타임라인', en: 'Factory Timeline', vi: 'Tiến độ nhà máy' },
    factoryScopeColumn: { ko: '공장', en: 'Factory', vi: 'Nhà máy' },
    headcount: {
      ko: '{count}명',
      en: '{count} ppl',
      vi: '{count} nguoi',
    ...
    ctSnapshotHint: {
      ko: '입력 CT를 비우면 ST(q) 값을 그대로 사용합니다. 현재 값은 작업 배정을 저장할 때 날짜/공장 정보와 함께 CT snapshot으로 저장됩니다.',
      en: 'If Entered CT is empty, the ST(q) value is used as-is. The current value is saved as a CT snapshot together with date and factory info when you save the assignment.',
      vi: 'Neu de trong CT nhap, se su dung nguyen gia tri ST(q). Gia tri hien tai se duoc luu thanh CT snapshot cung voi ngay va thong tin nha may khi ban luu phan cong.',
    },
...
Object.assign(UI_MESSAGES, {
  ...
  factoryBoard: {
    ...
    deleteSuccess: {
      ko: '공장을 삭제했습니다. 직원 {employeeCount}명도 함께 삭제되었습니다.',
      en: 'Factory deleted. Employees deleted: {employeeCount}.',
      vi: 'Đã xóa nhà máy và {employeeCount} nhân viên.',
    },
