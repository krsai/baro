...
export const UI_MESSAGES = {
  ...
  accessPolicy: {
    ...
    reset: {
      ...
      vi: 'Da ap dung gia tri mac dinh vao ban nhap. Hay luu de ap dung.',
    },
    systemAdminOnly: {
  ...
  payrollBoard: {
    title: { ko: '\uAE09\uC5EC \uACC4\uC0B0', en: 'Payroll', vi: 'Tinh luong' },
    add: { ko: '\uAE09\uC5EC \uACC4\uC0B0 \uCD94\uAC00', en: 'Add Payroll', vi: 'Them bang luong' },
    month: { ko: '\uC815\uC0B0 \uC6D4', en: 'Payroll Month', vi: 'Thang tinh luong' },
    employees: { ko: '\uB300\uC0C1 \uC778\uC6D0', en: 'Employees', vi: 'So nhan vien' },
    total: { ko: '\uCD1D \uAE09\uC5EC', en: 'Total Payroll', vi: 'Tong luong' },
    savedBy: { ko: '\uC800\uC7A5\uC790', en: 'Saved By', vi: 'Nguoi luu' },
    savedAt: { ko: '\uC800\uC7A5 \uC77C\uC2DC', en: 'Saved At', vi: 'Thoi gian luu' },
    status: { ko: '\uC0C1\uD0DC', en: 'Status', vi: 'Trang thai' },
    delete: { ko: '\uC0AD\uC81C', en: 'Delete', vi: 'Xoa' },
    snapshot: { ko: '\uC2A4\uB0C5\uC0F7', en: 'Snapshot', vi: 'Ban luu' },
    loading: { ko: '\uBD88\uB7EC\uC624\uB294 \uC911...', en: 'Loading...', vi: 'Dang tai...' },
    empty: {
      ko: "\uC800\uC7A5\uB41C \uAE09\uC5EC \uC2A4\uB0C5\uC0F7\uC774 \uC5C6\uC2B5\uB2C8\uB2E4. '\uAE09\uC5EC \uACC4\uC0B0 \uCD94\uAC00'\uB85C \uC2DC\uC791\uD574\uBCF4\uC138\uC694.",
  ...
  assign: {
    ...
    productionCompleteSuccess: {
      ...
      vi: 'Da xac nhan hoan thanh san xuat.',
    },
    productionCompletePayrollLocked: {
      ko: '급여 잠금이 끝난 배정카드는 완료 수량을 다시 확정할 수 없습니다.',
      en: 'Payroll-locked assignments cannot have their completed quantity changed.',
      vi: 'Khong the thay doi so luong hoan thanh cua the da khoa luong.',
    },
    productionCompleteError: {
      ko: '제작 완료 확정에 실패했습니다.',
      en: 'Failed to confirm production completion.',
      vi: 'Xac nhan hoan thanh san xuat khong thanh cong.',
    },
    closeModeFull: { ko: '정량 완료', en: 'Exact', vi: 'Hoan thanh dung so luong' },
    closeModeShort: { ko: '미달 완료', en: 'Short', vi: 'Hoan thanh thieu' },
    closeModeOver: { ko: '초과 완료', en: 'Over', vi: 'Hoan thanh vuot' },
