...
export const UI_MESSAGES = {
  ...
  payrollBoard: {
    ...
    empty: {
      ...
      vi: "Chua co ban luu phu cap san luong. Hay bat dau bang 'Them phu cap san luong'.",
    },
  ...
  assign: {
    ...
    productionCompletePayrollLocked: {
      ...
      vi: 'Khong the thay doi so luong hoan thanh cua the da chot phu cap san luong.',
    },
...
Object.assign(UI_MESSAGES, {
  ...
  factoryBoard: {
    ...
    columnWagePerSecond: { ko: '생산수당 초당 단가', en: 'Production Allowance / sec', vi: 'Phu cap san luong/giay' },
  ...
  factoryDetail: {
    ...
    countryCode: { ko: '\uAD6D\uAC00\uBC88\uD638', en: 'Country Code', vi: 'Ma quoc gia' },
    phoneNumber: { ko: '\uC804\uD654\uBC88\uD638', en: 'Phone Number', vi: 'So dien thoai' },
    targetMonthlyWage: { ko: '월 목표 생산수당', en: 'Target Monthly Production Allowance', vi: 'Phu cap san luong muc tieu hang thang' },
    wagePerSecond: { ko: '생산수당 초당 단가', en: 'Production Allowance / sec', vi: 'Phu cap san luong/giay' },
