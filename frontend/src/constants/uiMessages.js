...
Object.assign(UI_MESSAGES, {
  ...
  factoryDetail: {
    ...
    countryCode: { ko: '\uAD6D\uAC00\uBC88\uD638', en: 'Country Code', vi: 'Ma quoc gia' },
    phoneNumber: { ko: '\uC804\uD654\uBC88\uD638', en: 'Phone Number', vi: 'So dien thoai' },
    targetMonthlyWage: { ko: '레거시 월 목표 급여', en: 'Legacy Target Monthly Wage', vi: 'Muc luong thang cu' },
    wagePerSecond: { ko: '생산수당 초당 단가', en: 'Production Allowance / sec', vi: 'Phu cap san luong/giay' },
    targetMonthlyWageHelper: {
      ko: '신규 저장에는 사용하지 않는 레거시 값입니다.',
      en: 'Legacy value not used for new saves.',
      vi: 'Gia tri cu khong dung khi luu moi.',
    },
    wagePerSecondHelper: {
      ko: '성과급 직원의 작업수량 × CT초에 곱하는 공장 공통 단가',
      en: 'Factory-wide rate multiplied by performance workers’ quantity and CT seconds.',
      vi: 'Don gia chung cua nha may nhan voi so luong va giay CT cua nhan vien hieu suat.',
    },
  },
  organizationDetail: {
