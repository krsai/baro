...
export const UI_MESSAGES = {
  ...
  menu: {
    ...
    assignment: { ko: '작업 배정', en: 'Assignment', vi: 'Phan cong' },
    ...
    workHistory: { ko: '작업 기록', en: 'Work History', vi: 'Lich su cong viec' },
    attendance: { ko: '출퇴근 입력', en: 'Attendance Entry', vi: 'Cham cong' },
