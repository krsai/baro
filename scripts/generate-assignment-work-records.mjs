...
const PLANS = [
  ...
  {
    dbId: 58, lineId: 1, styleId: "S-2025SS-T001",
    label: "레귤러핏 라운드넥 티셔츠", customer: "테스트 발주자",
    colorId: 291, colorCode: "BLACK", colorName: "블랙",
    quantity: 400, startDateKey: "2026-03-16",
    processes: [
      { key: "P01", name: "원단 재단",    ct: 500 },
      { key: "P02", name: "앞판 봉제",    ct: 460 },
      { key: "P03", name: "뒷판 봉제",    ct: 480 },
      { key: "P04", name: "소매 봉제",    ct: 480 },
      { key: "P05", name: "넥밴드 부착",  ct: 420 },
      { key: "P06", name: "옆솔기 봉제",  ct: 400 },
      { key: "P07", name: "밑단 마감",    ct: 400 },
  ...
  {
    dbId: 59, lineId: 1, styleId: "S-2025SS-P002",
    label: "슬림핏 카라 폴로 셔츠", customer: "테스트 발주자",
    colorId: 290, colorCode: "WHITE", colorName: "화이트",
    quantity: 650, startDateKey: "2026-03-18",
    processes: [
      { key: "P01", name: "원단 재단",    ct: 550 },
      { key: "P02", name: "앞판 봉제",    ct: 500 },
      { key: "P03", name: "뒷판 봉제",    ct: 500 },
  ...
  {
    dbId: 60, lineId: 1, styleId: "S-2025FW-J003",
    label: "오버핏 데님 재킷", customer: "테스트 발주자",
    colorId: 294, colorCode: "LT-BLUE", colorName: "라이트블루",
    quantity: 470, startDateKey: "2026-03-24",
    processes: [
      { key: "P01", name: "원단 재단",           ct: 700 },
      { key: "P02", name: "심지 부착",           ct: 650 },
  ...
  {
    dbId: 61, lineId: 1, styleId: "S-2025FW-J003",
    label: "오버핏 데님 재킷", customer: "테스트 발주자",
    colorId: 296, colorCode: "INDIGO", colorName: "인디고",
    quantity: 440, startDateKey: "2026-03-30",
    processes: [
      { key: "P01", name: "원단 재단",           ct: 700 },
      { key: "P02", name: "심지 부착",           ct: 650 },
      { key: "P03", name: "앞판 봉제",           ct: 650 },
  ...
  {
    dbId: 52, lineId: 2, styleId: "S-2025SS-T001",
    label: "레귤러핏 라운드넥 티셔츠", customer: "테스트 발주자",
    colorId: 291, colorCode: "BLACK", colorName: "블랙",
    quantity: 600, startDateKey: "2026-03-13",
    processes: [
      { key: "P01", name: "원단 재단",    ct: 500 },
      { key: "P02", name: "앞판 봉제",    ct: 460 },
      { key: "P03", name: "뒷판 봉제",    ct: 440 },
  ...
  {
    dbId: 53, lineId: 2, styleId: "S-2025SS-T001",
    label: "레귤러핏 라운드넥 티셔츠", customer: "테스트 발주자",
    colorId: 292, colorCode: "NAVY", colorName: "네이비",
    quantity: 600, startDateKey: "2026-03-17",
    processes: [
      { key: "P01", name: "원단 재단",    ct: 500 },
      { key: "P02", name: "앞판 봉제",    ct: 460 },
      { key: "P03", name: "뒷판 봉제",    ct: 440 },
  ...
  {
    dbId: 54, lineId: 2, styleId: "S-2025SS-P002",
    label: "슬림핏 카라 폴로 셔츠", customer: "테스트 발주자",
    colorId: 290, colorCode: "WHITE", colorName: "화이트",
    quantity: 350, startDateKey: "2026-03-21",
    processes: [
      { key: "P01", name: "원단 재단",    ct: 550 },
      { key: "P02", name: "앞판 봉제",    ct: 500 },
      { key: "P03", name: "뒷판 봉제",    ct: 500 },
  ...
  {
    dbId: 55, lineId: 2, styleId: "S-2025FW-J003",
    label: "오버핏 데님 재킷", customer: "테스트 발주자",
    colorId: 294, colorCode: "LT-BLUE", colorName: "라이트블루",
    quantity: 380, startDateKey: "2026-03-25",
    processes: [
      { key: "P01", name: "원단 재단",           ct: 700 },
      { key: "P02", name: "심지 부착",           ct: 650 },
      { key: "P03", name: "앞판 봉제",           ct: 650 },
  ...
  {
    dbId: 56, lineId: 2, styleId: "S-2025FW-J003",
    label: "오버핏 데님 재킷", customer: "테스트 발주자",
    colorId: 295, colorCode: "MID-BLUE", colorName: "미드블루",
    quantity: 380, startDateKey: "2026-03-30",
    processes: [
      { key: "P01", name: "원단 재단",           ct: 700 },
      { key: "P02", name: "심지 부착",           ct: 650 },
      { key: "P03", name: "앞판 봉제",           ct: 650 },
