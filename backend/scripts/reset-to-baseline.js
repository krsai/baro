...
const BASELINE_ROLES = [
  { code: 'WORKER_CUTTING', name: '\uC7AC\uB2E8', defaultPayType: 'OUTPUT', sortOrder: 1 },
  { code: 'WORKER_SEWING', name: '\uBD09\uC81C', defaultPayType: 'OUTPUT', sortOrder: 2 },
  { code: 'WORKER_IRONING', name: '\uB2E4\uB9BC', defaultPayType: 'OUTPUT', sortOrder: 3 },
  { code: 'WORKER_INSPECTION', name: '\uAC80\uC218', defaultPayType: 'OUTPUT', sortOrder: 4 },
  { code: 'WORKER_PACKING', name: '\uD3EC\uC7A5', defaultPayType: 'OUTPUT', sortOrder: 5 },
  { code: 'WORKER_OTHER', name: '\uAE30\uD0C0', defaultPayType: 'OUTPUT', sortOrder: 6 },
];
