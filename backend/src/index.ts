...
const PAGE_TRANSLATION_PAGE_CODE_MAX_LENGTH = 80;
const PAGE_TRANSLATION_KEY_MAX_LENGTH = 180;
const PAGE_TRANSLATION_NOTE_MAX_LENGTH = 500;

const normalizePageTranslationPageCode = (value: unknown): string => {
  ...
  return raw
    ...
    .replace(/^-+|-+$/g, "")
    .replace(/^\/+|\/+$/g, "")
    .slice(0, PAGE_TRANSLATION_PAGE_CODE_MAX_LENGTH);
};

const normalizePageTranslationKey = (value: unknown): string => {
  const raw = resolveOptionalString(value, "") ?? "";
  if (!raw) return "";
  ...
  return raw
    ...
    .replace(/_{2,}/g, "_")
    .replace(/^_+|_+$/g, "")
    .slice(0, PAGE_TRANSLATION_KEY_MAX_LENGTH);
};

const normalizePageTranslationText = (value: unknown): string | null => {
  const normalized = resolveOptionalString(value, null);
  return normalized === null ? null : normalized;
};

const normalizePageTranslationNote = (value: unknown): string | null => {
  const normalized = resolveOptionalString(value, null);
  if (!normalized) return null;
  return normalized.slice(0, PAGE_TRANSLATION_NOTE_MAX_LENGTH);
};

const toPageTranslationRowResponse = (row: any) => ({
  id: row?.id ?? null,
  pageCode: String(row?.pageCode ?? "").trim(),
  key: String(row?.translationKey ?? "").trim(),
  ...
  autoCollectedAt: row?.autoCollectedAt ?? null,
...
type PageTranslationCatalogCategory = "menu" | "auth";

type PageTranslationCatalogEntry = {
  pageCode: string;
  label: string;
  routePath: string;
  category: PageTranslationCatalogCategory;
...
const PAGE_TRANSLATION_FILE_EXTENSIONS = new Set([".js", ".jsx", ".ts", ".tsx"]);
const PAGE_TRANSLATION_LOW_SIGNAL_TEXT_SET = new Set([
  "small",
  "medium",
  "large",
  "text",
...
const PAGE_TRANSLATION_PAGE_CATALOG: PageTranslationCatalogEntry[] = [
  {
    pageCode: "order",
    label: "주문",
    routePath: "/order",
    category: "menu",
    sourceTargets: ["frontend/src/pages/App/Order.jsx", "frontend/src/pages/App/order"],
  },
  {
    pageCode: "style",
    label: "스타일",
    routePath: "/style",
    category: "menu",
    sourceTargets: ["frontend/src/pages/App/Style.jsx", "frontend/src/pages/App/style"],
  },
  {
    pageCode: "assignment",
    label: "작업 배정",
    ...
    category: "menu",
    sourceTargets: ["frontend/src/pages/App/Assign.jsx", "frontend/src/pages/App/assign"],
  },
  {
    pageCode: "production-plan",
    label: "작업 계획 현황",
  ...
  },
  {
    ...
    routePath: "/st-review",
    category: "menu",
    sourceTargets: ["frontend/src/pages/App/StReview.jsx"],
  },
  {
    pageCode: "work-history",
    label: "작업 기록",
    routePath: "/work-history",
    category: "menu",
    sourceTargets: ["frontend/src/pages/App/Work.jsx", "frontend/src/pages/App/work"],
  },
  {
    pageCode: "attendance",
    label: "출퇴근 입력",
    ...
    category: "menu",
    sourceTargets: ["frontend/src/pages/App/Attendance.jsx", "frontend/src/pages/App/attendance"],
  },
  {
    pageCode: "inventory",
    label: "재고 불출",
    routePath: "/inventory",
    category: "menu",
    sourceTargets: ["frontend/src/pages/App/Inventory.jsx", "frontend/src/pages/App/inventory"],
  },
  {
    pageCode: "payroll",
    label: "급여 계산",
    routePath: "/payroll",
    category: "menu",
    sourceTargets: ["frontend/src/pages/App/Payroll.jsx", "frontend/src/pages/App/payroll"],
  },
  {
    pageCode: "production-result",
    label: "생산 결과",
    routePath: "/production-result",
    category: "menu",
    sourceTargets: [
      "frontend/src/pages/App/ProductionResult.jsx",
      "frontend/src/pages/App/production/ProductionResultBoard.jsx",
    ],
  },
  {
    pageCode: "business",
    ...
    routePath: "/business",
    category: "menu",
    sourceTargets: ["frontend/src/pages/App/Organization.jsx", "frontend/src/pages/App/organization"],
  },
  {
    pageCode: "line",
    label: "라인 관리",
    routePath: "/line",
    category: "menu",
    sourceTargets: ["frontend/src/pages/App/Line.jsx", "frontend/src/pages/App/line"],
  },
  {
    pageCode: "employee",
    label: "직원 관리",
    routePath: "/employee",
    category: "menu",
    sourceTargets: ["frontend/src/pages/App/Employee.jsx", "frontend/src/pages/App/employee"],
  },
  {
    pageCode: "customer",
    label: "고객 관리",
    routePath: "/customer",
    category: "menu",
    sourceTargets: ["frontend/src/pages/App/Customer.jsx", "frontend/src/pages/App/customer"],
  },
  {
    pageCode: "holiday",
    label: "휴일 관리",
    routePath: "/holiday",
    category: "menu",
    sourceTargets: ["frontend/src/pages/App/Holiday.jsx", "frontend/src/pages/App/holiday"],
  },
  {
    pageCode: "profile",
    label: "개인 정보",
    routePath: "/profile",
    category: "menu",
    sourceTargets: ["frontend/src/pages/App/MyProfile.jsx"],
  },
  {
    pageCode: "system-setting",
    label: "구독 관리",
    routePath: "/system-setting",
    category: "menu",
    sourceTargets: ["frontend/src/pages/App/system/systemBoard.jsx", "frontend/src/pages/App/system/orgMembership.jsx"],
  },
  {
    pageCode: "attribute",
    label: "속성 관리",
    routePath: "/attribute",
    category: "menu",
    sourceTargets: ["frontend/src/pages/App/Attribute.jsx", "frontend/src/pages/App/attribute"],
  },
  {
    pageCode: "page-translations",
    label: "페이지 번역 관리",
    routePath: "/page-translations",
    category: "menu",
    sourceTargets: ["frontend/src/pages/App/PageTranslations.jsx", "frontend/src/pages/App/system/PageTranslationBoard.jsx"],
  },
  {
    pageCode: "system-onboarding",
    label: "가입 승인",
    routePath: "/system-onboarding",
    category: "menu",
    sourceTargets: ["frontend/src/pages/App/system/OnboardingBoard.jsx"],
  },
  {
    pageCode: "auth.login",
    label: "로그인",
    routePath: "/login",
    category: "auth",
    sourceTargets: ["frontend/src/pages/Auth/Login.jsx"],
  },
  {
    pageCode: "auth.signup",
    label: "회원가입",
    routePath: "/signup",
    category: "auth",
    sourceTargets: ["frontend/src/pages/Auth/SignUp.jsx"],
  },
  {
    pageCode: "auth.onboarding",
    label: "온보딩",
    routePath: "/onboarding",
    category: "auth",
    sourceTargets: ["frontend/src/pages/Auth/Onboarding.jsx"],
  },
  {
    pageCode: "auth.subscription-required",
    label: "구독 문의 안내",
    routePath: "/subscription-required",
    category: "auth",
    sourceTargets: ["frontend/src/pages/Auth/SubscriptionRequired.jsx"],
  },
  {
    pageCode: "auth.callback",
    label: "로그인 콜백",
    routePath: "/auth/callback",
    category: "auth",
    sourceTargets: ["frontend/src/pages/Auth/AuthCallback.jsx"],
  },
];

const PAGE_TRANSLATION_PAGE_CATALOG_BY_CODE = PAGE_TRANSLATION_PAGE_CATALOG.reduce(
  (map: Map<string, PageTranslationCatalogEntry>, entry) => {
    map.set(entry.pageCode, entry);
    return map;
  },
  new Map<string, PageTranslationCatalogEntry>()
);

const toPageTranslationCatalogResponse = (entry: PageTranslationCatalogEntry) => ({
...
const toRepoRelativePath = (absolutePath: string) =>
  path.relative(REPO_ROOT_DIR, absolutePath).replace(/\\/g, "/");

const normalizeExtractedPageText = (value: string) =>
  String(value ?? "")
    .replace(/\r/g, "")
    .replace(/\s+/g, " ")
    .trim();

const decodeJsEscapedText = (value: string) =>
  String(value ?? "")
    .replace(/\\n/g, "\n")
    .replace(/\\t/g, "\t")
    .replace(/\\"/g, "\"")
...
const isLikelyUiText = (value: string) => {
  const text = normalizeExtractedPageText(value);
  if (!text) return false;
  if (text.length > 280) return false;
  if (!/[\p{L}\p{N}]/u.test(text)) return false;
  if (/^(true|false|null|undefined)$/i.test(text)) return false;
  if (/^(https?:\/\/|\/api\/|\/[a-z0-9/_-]+)$/i.test(text)) return false;
  if (/^[A-Z0-9_.\-/:]+$/.test(text) && !/[가-힣]/.test(text)) return false;
  if (PAGE_TRANSLATION_LOW_SIGNAL_TEXT_SET.has(text.toLowerCase())) return false;

  const hasHangul = /[가-힣]/.test(text);
  const hasWhitespace = /\s/.test(text);
  const hasSentencePunctuation = /[.,!?():]/.test(text);
  if (!hasHangul && !hasWhitespace && !hasSentencePunctuation && /^[a-z0-9_-]+$/i.test(text)) {
    return false;
  }
  return true;
};

const toSourceTextHash = (value: string) =>
  crypto.createHash("sha1").update(value).digest("hex");

const resolveLineAndColumnFromIndex = (sourceCode: string, index: number) => {
  const head = sourceCode.slice(0, Math.max(0, index));
...
const toAutoTranslationKey = ({
  ...
  const relativeFile = toRepoRelativePath(sourceFile)
    .replace(/^frontend\/src\//, "")
    .replace(/\.(jsx?|tsx?)$/i, "")
    .replace(/[\\/]/g, ".");
  const rawKey = `auto.${relativeFile}.l${line}c${column}`;
  const normalizedKey = normalizePageTranslationKey(rawKey);
  if (normalizedKey.length <= PAGE_TRANSLATION_KEY_MAX_LENGTH) {
    return normalizedKey;
  }
  const suffix = toSourceTextHash(rawKey).slice(0, 10);
  const headLength = PAGE_TRANSLATION_KEY_MAX_LENGTH - suffix.length - 1;
  return `${normalizedKey.slice(0, Math.max(1, headLength))}.${suffix}`;
};

const isPageTranslationSourceFile = (absolutePath: string) => {
  const extension = path.extname(absolutePath).toLowerCase();
  return PAGE_TRANSLATION_FILE_EXTENSIONS.has(extension);
};

const collectPageTranslationSourceFilesRecursively = async (
  absolutePath: string
): Promise<string[]> => {
  const stats = await fs.stat(absolutePath).catch(() => null);
  if (!stats) return [];
  if (stats.isFile()) {
    return isPageTranslationSourceFile(absolutePath) ? [absolutePath] : [];
  }
  ...
  for (const entry of entries) {
    ...
    if (entry.isDirectory()) {
      const nestedFiles = await collectPageTranslationSourceFilesRecursively(nestedPath);
      result.push(...nestedFiles);
      continue;
    }
    if (!entry.isFile()) continue;
    if (!isPageTranslationSourceFile(nestedPath)) continue;
    result.push(nestedPath);
  }
  return result;
};

const collectPageTranslationSourceFiles = async (
  sourceTargets: string[]
): Promise<string[]> => {
  const files: string[] = [];
  for (const target of sourceTargets) {
    ...
    const absolutePath = path.resolve(REPO_ROOT_DIR, normalizedTarget);
    const collected = await collectPageTranslationSourceFilesRecursively(absolutePath);
...
const pushExtractedPageTextCandidate = ({
  map,
  sourceCode,
  sourceFile,
  index,
  ...
  map: Map<string, ExtractedPageText>;
  sourceCode: string;
  sourceFile: string;
  index: number;
  rawText: string;
}) => {
  const decodedText = decodeJsEscapedText(rawText);
  const sourceText = normalizeExtractedPageText(decodedText);
  if (!isLikelyUiText(sourceText)) return;
  const { line, column } = resolveLineAndColumnFromIndex(sourceCode, index);
  const key = toAutoTranslationKey({ sourceFile, line, column });
  const sourceHash = toSourceTextHash(sourceText);
  map.set(key, {
    key,
    sourceText,
    sourceHash,
    sourceFile: toRepoRelativePath(sourceFile),
    sourceLine: line,
  });
};

const extractPageTextCandidatesFromFile = async (
  sourceFile: string
): Promise<ExtractedPageText[]> => {
  const sourceCode = await fs.readFile(sourceFile, "utf8");
  const extractedMap = new Map<string, ExtractedPageText>();

  const jsxTextPattern = />([^<>{]+)</g;
  let jsxTextMatch: RegExpExecArray | null = null;
  while ((jsxTextMatch = jsxTextPattern.exec(sourceCode)) !== null) {
    pushExtractedPageTextCandidate({
      map: extractedMap,
      sourceCode,
      sourceFile,
      index: jsxTextMatch.index + 1,
      rawText: jsxTextMatch[1] ?? "",
    });
  }

  const jsxStringPropPattern =
    /\b(label|placeholder|helperText|title|aria-label|primary|secondary)\s*=\s*(?:"([^"]*)"|'([^']*)'|`([^`$\\]*(?:\\.[^`$\\]*)*)`)/g;
  let jsxStringPropMatch: RegExpExecArray | null = null;
  while ((jsxStringPropMatch = jsxStringPropPattern.exec(sourceCode)) !== null) {
    const rawText =
      jsxStringPropMatch[2] ?? jsxStringPropMatch[3] ?? jsxStringPropMatch[4] ?? "";
    const captureOffset =
      (jsxStringPropMatch[0] || "").lastIndexOf(rawText) >= 0
        ? (jsxStringPropMatch[0] || "").lastIndexOf(rawText)
        : 0;
    pushExtractedPageTextCandidate({
      map: extractedMap,
      sourceCode,
      sourceFile,
      index: jsxStringPropMatch.index + captureOffset,
      rawText,
    });
  }

  const objectLabelPattern =
    /\b(label|placeholder|helperText|title|message|text)\s*:\s*(?:"([^"]*)"|'([^']*)')/g;
  let objectLabelMatch: RegExpExecArray | null = null;
  while ((objectLabelMatch = objectLabelPattern.exec(sourceCode)) !== null) {
    const rawText = objectLabelMatch[2] ?? objectLabelMatch[3] ?? "";
    const captureOffset =
      (objectLabelMatch[0] || "").lastIndexOf(rawText) >= 0
        ? (objectLabelMatch[0] || "").lastIndexOf(rawText)
        : 0;
    pushExtractedPageTextCandidate({
      map: extractedMap,
      sourceCode,
      sourceFile,
      index: objectLabelMatch.index + captureOffset,
      rawText,
    });
  }

  const notificationPattern = /\bshowNotification\(\s*(?:"([^"]*)"|'([^']*)')/g;
  let notificationMatch: RegExpExecArray | null = null;
  while ((notificationMatch = notificationPattern.exec(sourceCode)) !== null) {
    const rawText = notificationMatch[1] ?? notificationMatch[2] ?? "";
    const captureOffset =
      (notificationMatch[0] || "").lastIndexOf(rawText) >= 0
        ? (notificationMatch[0] || "").lastIndexOf(rawText)
        : 0;
    pushExtractedPageTextCandidate({
      map: extractedMap,
      sourceCode,
      sourceFile,
      index: notificationMatch.index + captureOffset,
      rawText,
    });
  }

  return Array.from(extractedMap.values()).sort((left, right) => {
    const fileDiff = left.sourceFile.localeCompare(right.sourceFile);
...
const collectExtractedPageTexts = async (
  sourceTargets: string[]
): Promise<ExtractedPageText[]> => {
  const sourceFiles = await collectPageTranslationSourceFiles(sourceTargets);
  const allRows: ExtractedPageText[] = [];
  for (const sourceFile of sourceFiles) {
    const rows = await extractPageTextCandidatesFromFile(sourceFile);
    allRows.push(...rows);
  }
  return allRows;
};

const syncPageTranslationCatalogPage = async ({
  pageCode,
  requesterEmail,
}: {
  pageCode: string;
  ...
  const catalogEntry = PAGE_TRANSLATION_PAGE_CATALOG_BY_CODE.get(pageCode);
  if (!catalogEntry) {
    throw createHttpError(404, "page catalog entry not found");
  }

  let extractedRows = await collectExtractedPageTexts(catalogEntry.sourceTargets);
  if (catalogEntry.category === "menu") {
    const menuLabelText = normalizeExtractedPageText(catalogEntry.label);
    if (menuLabelText) {
      const menuLabelKey = normalizePageTranslationKey("menu.label");
      if (menuLabelKey) {
        extractedRows = [
          {
            key: menuLabelKey,
            sourceText: menuLabelText,
            sourceHash: toSourceTextHash(menuLabelText),
            sourceFile: "__catalog__/menu",
            sourceLine: 0,
          },
          ...extractedRows,
        ];
  ...
  const extractedByKey = new Map<string, ExtractedPageText>(
    extractedRows.map((row) => [row.key, row])
  );
  const now = new Date();

  const existingRows = await prisma.pageTranslation.findMany({
    where: { pageCode },
    orderBy: [{ translationKey: "asc" }],
  });
  const existingByKey = new Map(existingRows.map((row) => [row.translationKey, row]));
  ...
  for (const extracted of extractedRows) {
    ...
    if (!existing) {
      createdCount += 1;
      writes.push(
        prisma.pageTranslation.create({
          data: {
            pageCode,
            translationKey: extracted.key,
            textKo: extracted.sourceText,
            textEn: null,
            textVi: null,
    ...
    const hasSourceChanged =
      Boolean(existing.sourceHash) && existing.sourceHash !== extracted.sourceHash;
    const existingKoText = String(existing.textKo ?? "").trim();
    const existingSourceText = String(existing.sourceText ?? "").trim();
    const shouldUpdateKoText =
      !existingKoText || (existingSourceText && existingKoText === existingSourceText);
    const nextKoText = shouldUpdateKoText ? extracted.sourceText : existing.textKo;
    if (hasSourceChanged) {
      changedCount += 1;
    } else {
      unchangedCount += 1;
    ...
    writes.push(
      prisma.pageTranslation.update({
        ...
        data: {
          ...
          sourceLine: extracted.sourceLine,
          autoCollectedAt: now,
          needsReview: hasSourceChanged ? true : existing.needsReview,
          isActive: true,
          updatedBy: requesterEmail,
        },
      })
  ...
  const staleAutoRows = existingRows.filter(
    (row) => Boolean(row.sourceFile) && !extractedByKey.has(row.translationKey)
  );
  for (const staleRow of staleAutoRows) {
    deactivatedCount += 1;
    writes.push(
      prisma.pageTranslation.update({
  ...
  const rows = await prisma.pageTranslation.findMany({
    where: { pageCode },
    orderBy: [{ pageCode: "asc" }, { translationKey: "asc" }],
  });
  ...
  return {
    ...
    rows: rows.map(toPageTranslationRowResponse),
  };
};
...
app.get("/system/page-translations", async (req, res) => {
  const systemAdmin = await requireSystemAdmin(req, res);
  if (!systemAdmin) return;

  const pageCode = normalizePageTranslationPageCode(req.query.pageCode);
  const searchText = resolveOptionalString(req.query.search, "") ?? "";
  ...
  if (searchText) {
    where.OR = [
      { translationKey: { contains: searchText, mode: "insensitive" } },
      { textKo: { contains: searchText, mode: "insensitive" } },
      { textEn: { contains: searchText, mode: "insensitive" } },
      { textVi: { contains: searchText, mode: "insensitive" } },
      { sourceText: { contains: searchText, mode: "insensitive" } },
      { note: { contains: searchText, mode: "insensitive" } },
    ];
  }

  const [rows, pageCodeRows] = await Promise.all([
    prisma.pageTranslation.findMany({
      where,
      orderBy: [{ pageCode: "asc" }, { translationKey: "asc" }],
    }),
    prisma.pageTranslation.findMany({
      select: { pageCode: true },
      distinct: ["pageCode"],
      orderBy: { pageCode: "asc" },
    }),
  ]);

  return res.json({
    rows: rows.map(toPageTranslationRowResponse),
    pageCodes: Array.from(
      new Set([
        ...PAGE_TRANSLATION_PAGE_CATALOG.map((item) => item.pageCode),
        ...pageCodeRows.map((item) => item.pageCode),
      ])
    ).sort((left, right) => left.localeCompare(right)),
    catalog: PAGE_TRANSLATION_PAGE_CATALOG.map(toPageTranslationCatalogResponse),
  });
});

app.post("/system/page-translations/sync", async (req, res) => {
  const systemAdmin = await requireSystemAdmin(req, res);
  if (!systemAdmin) return;

  const pageCode = normalizePageTranslationPageCode(req.body?.pageCode);
  if (!pageCode) {
    return res.status(400).json({ ok: false, error: "pageCode is required" });
  }
  if (!PAGE_TRANSLATION_PAGE_CATALOG_BY_CODE.has(pageCode)) {
    return res.status(404).json({ ok: false, error: "pageCode is not in catalog" });
  }

  const result = await syncPageTranslationCatalogPage({
    pageCode,
    requesterEmail: systemAdmin.requesterEmail,
  });

  return res.json(result);
});

app.put("/system/page-translations", async (req, res) => {
  const systemAdmin = await requireSystemAdmin(req, res);
  if (!systemAdmin) return;
  ...
  if (!pageCode) {
    return res
      .status(400)
      .json({ ok: false, error: "pageCode is required" });
  }
  ...
  const normalizedRows: Array<{
    ...
    .map((item: any) => ({
      key: normalizePageTranslationKey(item?.key ?? item?.translationKey),
      textKo: normalizePageTranslationText(item?.textKo),
      textEn: normalizePageTranslationText(item?.textEn),
      textVi: normalizePageTranslationText(item?.textVi),
      isActive: item?.isActive !== false,
      note: normalizePageTranslationNote(item?.note),
    }))
    .filter((item: any) => Boolean(item.key));
  ...
  await prisma.$transaction(async (tx) => {
    const existingRows = await tx.pageTranslation.findMany({
      where: { pageCode },
      select: { id: true, translationKey: true },
    });
    const incomingKeySet = new Set<string>(normalizedRows.map((row) => row.key));
    const deleteIds = existingRows
      .filter((row) => !incomingKeySet.has(row.translationKey))
      .map((row) => row.id);
